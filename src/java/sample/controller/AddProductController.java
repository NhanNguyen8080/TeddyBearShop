...
public class AddProductController extends HttpServlet {
    ...
    private static final String LIST_PRODUCT_CONTROLLER = "ListProductsController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean checkDuplicate = dao.checkDuplicate(bear.getBearID());
            if (checkDuplicate) {
                request.setAttribute("PRODUCT_DUPLICATE", "Teddy bear has already exist!!!");
            } else {
                boolean checkAdd = dao.addAProduct(bear);
                if (checkAdd) {
